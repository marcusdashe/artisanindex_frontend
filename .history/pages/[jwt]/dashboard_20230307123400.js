            ...
            {action === "Upload" ? (
              <>
                ...
                <div className="h-[90vh] w-full p-3 flex flex-col">
                  ...
                  {files.length > 0 ? (
                    <div className="w-full h-[30vh] mt-5 p-1">
                      {files.map((file) => {
                        return (
                          <li className="w-full h-[4vh] p-5 flex items-center content-center justify-between rounded-md bg-slate-300">
                            {file.name}
                            <span className="bg-slate-900 text-white text-sm p-1 pl-3 pr-3 rounded-full">
                              File Size {file.size}
                            </span>
                          </li>
                        );
